...
$config['admin_email']                = "darwintherudito@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'consultores';           // Default group, use name
...
$config['message_start_delimiter'] = "<div class='alert alert-dismissable alert-warning'>
    <button type='button' class='close' data-dismiss='alert'>×</button>"; 	// Message start delimiter
...
$config['error_start_delimiter']   = "<div class='alert alert-dismissable alert-warning'>
    <button type='button' class='close' data-dismiss='alert'>×</button>";		// Error message start delimiter
