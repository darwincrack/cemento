            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-table fa-fw"></i> Lorem ipsum</a>
                        </li>
                        ...
                        <li class="active">
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> consectetur <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="blank.html">En construccion</a>
                                </li>
                                <li>
                                    <a href="login.html">blandit </a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
